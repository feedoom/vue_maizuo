...
export default new Vuex.Store({
  ...
  mutations: {
    ...
    filmHeaderShow(state) {
      state.isFilmHeaderShow = true
    },
    filmHeaderHidden(state) {
      state.isFilmHeaderShow = false
    }
  },
  actions: {
    getComingListAction(store, page) {
      ...
      axios({
        url: `https://m.maizuo.com/gateway?cityId=${cityId}&pageNum=${page}&pageSize=10&type=2`,
        headers: {
          'X-Client-Info':
    ...
    getNowListAction(store, page) {
      ...
      axios({
        url: `https://m.maizuo.com/gateway?cityId=${cityId}&pageNum=${page}&pageSize=10&type=1`,
        headers: {
          'X-Client-Info':
