  ...
  <div>
    <html>
      <head>
        ...
        <meta content="maizuo-fe" name="author" />
        <meta name="copyright" content="Copyright (c) 2015 Maizuo-fe." />
        <meta
        ...
        <link
          href="https://assets.maizuo.com/h5/v5/public/app/css/app.50919e9088f5a9735b1aec0c8d3f0f4f.css"
          rel="stylesheet"
        />
        <script
          ...
          charset="utf-8"
          async=""
          src="https://assets.maizuo.com/h5/v5/public/app/js/18.f7c452d2185ee134202d.js"
        ></script>
        <script
          type="text/javascript"
          charset="utf-8"
          async=""
          src="https://assets.maizuo.com/h5/v5/public/app/js/35.550e43485f60419ffb73.js"
        ></script>
        <script
          type="text/javascript"
          charset="utf8"
          async=""
          src="//assets.growingio.com/2.1/gio.js"
        ></script>
        <style id="bec2cf32-2896-4b82-a561-a48f627502b1">
          #ShowUpBox {
            all: unset;
            width: auto;
            height: auto;
          ...
          .tipUp {
            background: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAkAAAAJCAYAAADgkQYQAAAAZElEQVQYlXXMIQ4CMBBE0UWhwHDw+ddCAhILEgWy4WNo0tAyyZidly1AwNba1CSvJOf6h/oduC/RAN7qfkJ9BC7VM6LhQ1O3E+pN8lAPNeYHHGsV4PkFN3WzREmuwEndLUFVfQC3Xa8Jl+92RAAAAABJRU5ErkJggg==)
              0px 0px no-repeat transparent;
            margin-top: -2px;
            margin-bottom: 0px;
          }
          .tipDown {
            background: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAkAAAAJCAYAAADgkQYQAAAAXElEQVQYlYXMsQ5AQBREUSoVjQ+f+S0lSi2livJlr4ZEZDcmud3JVJIW2yPQVqXZPmwjaQXqEuJJ0vCLbrgDfRZFxBsH0GTRCybbcxF9HhPQZdEHbkUUEUg6JU0Xm2KvCU6v27kAAAAASUVORK5CYII=)
              0px 0px no-repeat transparent;
            margin-top: 0px;
            margin-bottom: -2px;
          }
        ...
        <style type="text/css">
          .billboards[data-v-5e9d3622] {
            height: 56vw;
          }
          .billboards .item-wrap[data-v-5e9d3622] {
            height: 100%;
            width: 100%;
            display: block;
          }
        ...
        <style type="text/css">
          ...
          .nowPlayingList-wrap .err-cover {
            width: 100%;
            z-index: 3000;
            position: fixed;
            background-color: #fff;
          }
          .nowPlayingList-wrap .err-cover .cover-content {
            position: absolute;
            top: 107px;
            width: 100%;
            text-align: center;
          }
          .nowPlayingList-wrap .err-cover .cover-content img {
            width: 90px;
            margin: auto;
          }
          .nowPlayingList-wrap .err-cover .cover-content p {
            color: #bdc0c5;
            font-size: 14px;
            margin: 0;
          }
          ...
          .nowPlayingList-wrap
            ...
            .nowPlayingFilm-img
            .lazy-img-wrap,
          .nowPlayingList-wrap li .nowPlayingFilm-wrap .nowPlayingFilm-img img {
            border-radius: 2px;
          }
          ...
          .nowPlayingList-wrap li .nowPlayingFilm-buy:active {
            background: #ff5f16;
            color: #fff;
          }
          .nowPlayingList-wrap .no-more {
            height: 59px;
          ...
          .nowPlayingList-wrap .page-infinite-loading span {
            display: inline-block;
            vertical-align: middle;
            margin-right: 5px;
          }
        ...
        <script
          ...
          charset="utf-8"
          async=""
          src="https://assets.maizuo.com/h5/v5/public/app/js/24.dc16c19d01415a86ce0f.js"
        ></script>
        <style type="text/css">
          .center-view {
            position: relative;
      ...
      <body>
        <div class="main">
          <div class="center-view" data-enter-time="1599380820">
            <div
              class="avatar"
              data-enter-time="1599380820"
              data-click-fun="track_f_699297"
            >
              <img
            ...
            <ul class="my-order-tab">
              <li data-enter-time="1599380820" data-click-fun="track_f_413845">
                <img
              ...
              <li data-enter-time="1599380820" data-click-fun="track_f_25470">
                <img
